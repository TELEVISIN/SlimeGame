...
public class Paladin extends Player {
	...
	public Paladin(Coordinate2D coordinate2d, SlimeGame slimeGame, HealthText healthText, int health, double speed, double attackPower, double attackSpeed) {
		super(coordinate2d, slimeGame, healthText, health, speed, attackPower, attackSpeed);
